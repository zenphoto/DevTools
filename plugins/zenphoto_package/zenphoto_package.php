...
filter::registerFilter('admin_utilities_buttons', 'zenphoto_package_button');
...
function zenphoto_package_button($buttons) {
	$buttons[] = array(
			...
			'action' => FULLWEBPATH . '/' . USER_PLUGIN_FOLDER . '/zenphoto_package/zenphoto_package_generator.php',
