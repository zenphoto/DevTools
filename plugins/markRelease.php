<?php
/**
 * Removes the qualifiers from the version file so that the install is not marked as a debug installation
 *
 * @package plugins
...
function markRelease_button($buttons) {
	...
	$buttons[] = array(
			'category'=>gettext('Development'),
								...
								'alt'=>'',
								'hidden'=> '<input type="hidden" name="markRelease" value="mark" />',
								'rights'=> ADMIN_RIGHTS,
